        ...
        register_post_type('what-we-do',
            array(
                'labels'                =>          array(
                    ...
                    'all_items'         =>          'All', //nome link per visualizzare tutti i post
                    'add_new'           =>          'Add person', //nome link per aggiungere nuovo post
                    'add_new_item'      =>          'Add person', //titolo della pagina di aggiunta di un nuovo post
                    'edit_item'         =>          'Edit person', //titolo della pagina di aggiunta di un nuovo post
                    'new_item'          =>          'New person',
                    'view_item'         =>          'See person',
                    'search_items'      =>          'Search', //testo nel pulsante di ricerca
                    'not_found'         =>          'Nessun elemento trovato',
                    'not_found_in_trash'=>          'Nessun elemento nel cestino',
                    'parent_item_colon' =>          '',
